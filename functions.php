...
function ccfk_scripts() {
	wp_enqueue_style( 'ccfk-style', get_template_directory_uri() . '/assets/build/css/common.css' );
	wp_enqueue_script( 'ccfk-scripts', get_template_directory_uri() . '/assets/build/js/common.js' );
}
